...
class ViewBase extends View {
     ...
     * @return string
     */
    public static function resolveCRUDTemplate($ctrl, $act){
        $act = strtolower($act);
        switch($act){
            case 'index':
                return __DIR__.'/tpl2/crud/index.php';

            case 'update':
                return __DIR__.'/tpl2/crud/update.php';

            case 'info':
                return __DIR__.'/tpl2/crud/info.php';
        }
    }
