...
<div id="col-main">
	...
	<ul class="sample_list">
		...
		<li>
			...
			<span class="sample-type-flag"><?php echo $sample->sample_type == GlobalConf::SAMPLE_TYPE_SINGLE ? '单品' : '套件';?></span>
		</li>
		<?php endforeach;?>
	</ul>
	<?php else:?>
	...
	<style>
		...
		.sample_list .thumb {width:150px; height:120px;  overflow:hidden; display:block; background-color:white; padding:10px;}
		.sample_list .thumb img {height:120px;}
