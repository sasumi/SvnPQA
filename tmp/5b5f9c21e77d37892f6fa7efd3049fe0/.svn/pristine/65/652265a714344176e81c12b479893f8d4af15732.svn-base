 ...
 * @property string $unit_name 货币单位
 * @method static TableCurrency|Query meta()
 * @method boolean onBeforeSave()
 * @method boolean onBeforeUpdate()
 * @method boolean onBeforeInsert()
 * @method static string getDbTablePrefix($type = TableCurrency::DB_READ)
 * @method static TableCurrency|Query setQuery($query = null, $db_config = array())
 * @method Query getQuery()
 * @method static \Exception transaction($handler)
 * @method \PDOStatement execute()
 * @method static TableCurrency|Query find($statement = '', $var = null, ...$var2)
 * @method static TableCurrency|Query order($statement='')
 * @method static TableCurrency|Query|bool create($data)
 * @method static TableCurrency|Query|array findOneByPk($val, $as_array = false)
 * @method static TableCurrency|Query|array findByPks(array $pks, $as_array = false)
 ...
 * @method TableCurrency|Query|array|null one($as_array = false)
 ...
 */
abstract class TableCurrency extends Model {
