...
/**
 * Class TableCustomerSource

 * @property-read int $id 
 * @property string $name 名称
 * @property mixed $state 状态(禁用,启用)
 * @method static TableCustomerSource|Query meta()
 * @method boolean onBeforeSave()
 * @method boolean onBeforeUpdate()
 * @method boolean onBeforeInsert()
 * @method static string getDbTablePrefix($type = TableCustomerSource::DB_READ)
 * @method static TableCustomerSource|Query setQuery($query = null, $db_config = array())
 * @method Query getQuery()
 * @method static \Exception transaction($handler)
 * @method \PDOStatement execute()
 * @method static TableCustomerSource|Query find($statement = '', $var = null, ...$var2)
 * @method static TableCustomerSource|Query order($statement='')
 * @method static TableCustomerSource|Query|bool create($data)
 * @method static TableCustomerSource|Query|array findOneByPk($val, $as_array = false)
 * @method static TableCustomerSource|Query|array findByPks(array $pks, $as_array = false)
 ...
 * @method TableCustomerSource|Query|array|null one($as_array = false)
 ...
 */
abstract class TableCustomerSource extends Model {
