 ...
 * @method static TableSupplier|Query meta()
 * @method boolean onBeforeSave()
 * @method boolean onBeforeUpdate()
 * @method boolean onBeforeInsert()
 * @method static string getDbTablePrefix($type = TableSupplier::DB_READ)
 * @method static TableSupplier|Query setQuery($query = null, $db_config = array())
 * @method Query getQuery()
 * @method static \Exception transaction($handler)
 * @method \PDOStatement execute()
 * @method static TableSupplier|Query find($statement = '', $var = null, ...$var2)
 * @method static TableSupplier|Query order($statement='')
 * @method static TableSupplier|Query|bool create($data)
 * @method static TableSupplier|Query|array findOneByPk($val, $as_array = false)
 * @method static TableSupplier|Query|array findByPks(array $pks, $as_array = false)
 ...
 * @method TableSupplier|Query|array|null one($as_array = false)
 ...
 */
abstract class TableSupplier extends Model {
