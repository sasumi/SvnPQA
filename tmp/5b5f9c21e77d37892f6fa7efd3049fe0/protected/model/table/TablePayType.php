 ...
 * @method static TablePayType|Query meta()
 * @method boolean onBeforeSave()
 * @method boolean onBeforeUpdate()
 * @method boolean onBeforeInsert()
 * @method static string getDbTablePrefix($type = TablePayType::DB_READ)
 * @method static TablePayType|Query setQuery($query = null, $db_config = array())
 * @method Query getQuery()
 * @method static \Exception transaction($handler)
 * @method \PDOStatement execute()
 * @method static TablePayType|Query find($statement = '', $var = null, ...$var2)
 * @method static TablePayType|Query order($statement='')
 * @method static TablePayType|Query|bool create($data)
 * @method static TablePayType|Query|array findOneByPk($val, $as_array = false)
 * @method static TablePayType|Query|array findByPks(array $pks, $as_array = false)
 ...
 * @method TablePayType|Query|array|null one($as_array = false)
 ...
 */
abstract class TablePayType extends Model {
